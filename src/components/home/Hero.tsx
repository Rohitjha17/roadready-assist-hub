        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              India's Trusted Roadside Assistance When You Need It Most
            </h1>
            <p className="text-lg md:text-xl mb-8 text-gray-100">
              We're here 24/7 to help you get back on the road. Fast response times across India, professional service, and affordable rates starting at just ₹499.
            </p>
          ...
          <div className="hidden lg:block">
            <img
              src="https://images.unsplash.com/photo-1628935333637-a98e31de5d71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
              alt="India Road Assistance"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Button variant="ghost" className="flex flex-col items-center p-4 h-auto">
              ...
              <span className="text-xs text-gray-500">From ₹999</span>
            </Button>
            <Button variant="ghost" className="flex flex-col items-center p-4 h-auto">
              ...
              <span className="text-xs text-gray-500">From ₹499</span>
            </Button>
            <Button variant="ghost" className="flex flex-col items-center p-4 h-auto">
              <svg className="h-8 w-8 mb-2 text-orva-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Button variant="ghost" className="flex flex-col items-center p-4 h-auto">
              ...
              <span className="text-xs text-gray-500">From ₹699</span>
            </Button>
          </div>
        </div>
      </div>
